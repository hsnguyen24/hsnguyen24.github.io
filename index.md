...
I'm Sean, a M.S. student at Oregon State University working as a graduate research assistant with [Prof. Xiao Fu](https://web.engr.oregonstate.edu/~fuxia). I received my B.Eng. in Artificial Intelligence (with first-class honours) from The Chinese University of Hong Kong in March 2024, working with [Prof. Hoi-To Wai](https://www1.se.cuhk.edu.hk/~htwai) on graph signal processing. My current research focuses on principled methods for matrix factorization and unsupervised deep learning, with provable guarantees on identifiability and robustness. Outside of work, my hobbies are writing, cooking, and photography.
